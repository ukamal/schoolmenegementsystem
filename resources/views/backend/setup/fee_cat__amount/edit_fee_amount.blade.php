    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manage Update Fee Amount</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Update Fee Amount</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('fee-cat-amount-update',$amounts[0]->fee_category_id) }}" method="post" id="myForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="add_item">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="fee_category_id" id="" class="form-control">
                                                    ...
                                                    @foreach ($feeCategories as $feeCategory)
                                                        <option value="{{$feeCategory->id}}" {{($amounts['0']->fee_category_id==$feeCategory->id)?"selected":""}}>{{$feeCategory->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        @foreach ($amounts as $edit)
