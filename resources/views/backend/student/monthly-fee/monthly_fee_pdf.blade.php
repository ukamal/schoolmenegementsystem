    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <h5 style="font-weight: bold">Student Monthly Fee Slip</h5>
            </div>
            <div class="col-md-12 wrapper">
                @php
                    $monthlyfee = 
                    App\Models\FeeCatAmount::where('fee_category_id','2')->where('class_id',$std->class_id)->first();
                ...
                <table border="1" width="100%">
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 50%">Fee (This Student) of {{$months}}:</td>
                            <td>{{$finalfee}}</td>
                        </tr>
                    </tbody>
                </table>
