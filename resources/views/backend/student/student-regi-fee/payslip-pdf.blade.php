...
<html lang="en">
  <head>
    ...
    <title>Student Registration Fee Slip</title>
    <style>
       table{
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <h5 style="font-weight: bold">Student Registration Fee Slip</h5>
            </div>
            <div class="col-md-12 wrapper">
                @php
                    $registrationfee = 
                    App\Models\FeeCatAmount::where('fee_category_id','1')->where('class_id',$std->class_id)->first();
