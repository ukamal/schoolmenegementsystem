        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-header">
              <h3>
                Edit Profile
                <a href="{{ route('view-profile') }}" class="btn btn-primary float-sm-right"> <i class="fas fa-user"></i>Back</a>
              </h3>
              </div>
              <div class="card-body">
                <form action="{{ route('update-profile') }}" method="post" id="myForm" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
